...
public class AndroidWebview : MonoBehaviour {
    ...
    protected void Delegation (string message) {
        ...
        //if (statusText != null)
        {
            ...
            if(message.Contains("onPageFinished"))
            {
    ...
    protected AndroidJavaObject StartOnTextureId (int texWidth, int texHeight) {
        ...
        JRMGX_Android_View_SetTextureDetails (texWidth, texHeight);
    ...
    #endregion
    bool initFinish;
    public void Init(int _width,int _height,string _url)
    {
#if !UNITY_EDITOR
